...
class FormeConfigurableCallbacks extends FormeConfigurableParam {
    ...
    checkValueType(value) {
        return typeof value === 'function' || (Array.isArray(value) && value.count(callback => typeof callback !== 'function') === 0);
    }
}
...
class FormeConfigurableStrings extends FormeConfigurableParam {
    ...
    checkValueType(value) {
        return typeof value === 'string' || (Array.isArray(value) && value.count(callback => typeof callback !== 'string') === 0);
    }
}
