...
class Input {
    ...
    next(context) {
        this.value('forme:next');
        return this.action('forme:next', 'forme:next', context);
    }

    prev(context) {
        this.value('forme:prev');
        return this.action('forme:prev', 'forme:prev', context);
    }
    ...
    error(storage, message) {
        ...
        this._form.error(storage, this._name, message);
    }
