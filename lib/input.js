    ...
    _buildValues(options, parent) {
        ...
        if (this._buildValuesInclude(options)) {
            ...
            if (options.store) {
                ...
                value = this._form._request._getStoreValue(this._pathSegments, defaultValue);
            } else {
                value = defaultValue;
            }
            ...
            if (options.raw) {
                //uses this._name as we want submitted values (not the "nice" _outputName..)
                if (this._form._request._raw.hasOwnProperty(this._name)) {
                    value = this._form._request._raw[this._name];
                }
            } else {
                //uses this._name as we want submitted values (not the "nice" _outputName..)
                if (this._form._request._values.hasOwnProperty(this._name)) {
        ...
        .then(parent => {
            ...
            if (!this._template) {
                ...
                if (this._templateClient) {
                    ...
                    return utils.promise.result(this._form._driver.renderInputTemplate(this._form, this, this._template, parent))
                    .then(rendered => {
