...
class FormeRequest {
    ...
    _load() {
        if (this._form._driver) {
            ...
            return this._form._driver.timeout()//timeout old sessions
            ...
            .then(data => {
                ...
                if (data !== null) {
                    //make sure to create new copies of objects/arrays, because we dont want anything to delete/alter them
    ...
    _visited() {
        return this._started && !this._pageFirst;
    }
