...
class FormePage extends FormeContainer {
    ...
    _build() {
        ...
        if (!this._callback) {
            ...
            return utils.promise.result(this._callback.call(this, this._form._storage._container, this._form, this))
            .then(() => this);
        }
    }
    ...
    add(name) {
        if (this._form._request !== null) {
            if (!this._form._request._building) {
