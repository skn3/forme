...
class Forme extends FormeContainer {
    ...
    _build(view, submit, values) {
        return this._buildSteps(view, submit, values, [
            ...
            //page
            (view, submit, values) => this._buildImport(view, submit, values),
    ...
    _buildRequest(view, submit, values) {
        ...
        this._currentRequest._pageFirst = !submit && !this._currentRequest._hasVisitedPage();
    }

    _buildImport(view, submit, values) {
        //import the elements from the current page
        const page = this._requestPage;
        if (page) {
            for(let element of page._elements) {
    ...
    _buildValuesSelf(options) {
        if (options.pages) {
            ...
            return utils.merge({}, this._request._getMergedStoreValues(null, false), super._buildValuesSelf(options));
        } else {
            //just this form/page
