...
class Forme extends FormeContainer {
    ...
    _buildRead(view, submit, values) {
        ...
        return new Promise((resolve, reject) => {
            ...
            const buildRaw = {};//values submitted
    ...
    _buildValuesSelf(options) {
        if (options.pages) {
            ...
            return utils.merge.dontOverwriteWithNull({}, this._currentRequest._getMergedElementStoreValues(null, false), super._buildValuesSelf(options));
        } else {
            //just this form/page
