...
class Forme extends FormeContainer {
    ...
    submit() {
        if (arguments.length >= 1 && typeof arguments[0] == 'function' && this._request === null) {
            //add submit handler
            return super.submit(...arguments)
        } else if (arguments.length >= 1 && typeof arguments[0] == 'object' && this._request !== null) {
            //submit form
    ...
    next() {
        if (arguments.length == 1 && this._request === null) {
            return super.action(constants.actionPrefix + 'next', arguments[0]);
        } else if (arguments.length == 2 && this._request !== null) {
