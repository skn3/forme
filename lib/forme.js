    ...
    _buildRead(values) {
        ...
        return new Promise((resolve, reject) => {
            ...
            for (let input of this._inputs) {
                buildRaw[input._name] = this._readInputValue(input, this._requestFirst, this._currentRequest._submit, true, false, null, values);//raw values cant read from store
                buildValues[input._name] = this._readInputValue(input, this._requestFirst, this._currentRequest._submit, false, !this._currentRequest._submit, null, values);//can only read from the store when NOT submitting
            }
