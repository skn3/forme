...
class Forme extends FormeContainer {
    ...
    _buildRequest(view, submit) {
        ...
        //set first states
        if (submit) {
            this._request._formFirst = false;
        }

        this._request._pageFirst = this._request._formFirst && (this._request._page == null || !this._request._store.visited[this._request._current]);

        if (!submit) {
            this._request._formFirst = this._request._pageFirst;
        }
    }
    ...
    _makeTemplate() {
        ...
        const template = {
            form: {
                ...
                first: this._request._pageFirst,
