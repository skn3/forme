    ...
    _buildTemplate(reqForm) {
        ...
        for (let inputIndex = 0; inputIndex < inputs.length; inputIndex++) {
            ...
            const buildInput = {
                ...
                checked: (reqForm.first && input._checked) || (type == 'checkbox' && formRaw[input._name] !== null) || (type != 'checkbox' && !reqForm.first && formRaw[input._name] == formValues[input._name]),
                errors: errors,
