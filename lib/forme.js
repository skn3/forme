...
class Forme {
    ...
    _fetchValues(req, secure, group, raw) {
        //build values
        const values = {};
        const groupState = {};
    ...
    values(req) {
        //get all values
        return this._fetchValues(req, false, true, false);
    }
    ...
    validate(req) {
        ...
        return this._process(req, true).then(function() {
            ...
            return {
                ...
                req: req,
                form: that,
                values: that._fetchValues(req, false, true, false),
                errors: null,
            };
        }).catch(function(err){
    ...
    store(req) {
        ...
        if (this._sessionHandler) {
            ...
            let data = {
                raw: this._fetchValues(req, true, false, true),
                values: this._fetchValues(req, true, false, false),
