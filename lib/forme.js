...
class Forme extends FormeContainer {
    ...
    _buildRequest(view, submit) {
        ...
        //set first state
        if (!submit) {
            //if we are *not* submitting then we need to check if the page has been visited
            this._request._first = !this._request._visited();
        } else {
    ...
    _makeTemplate() {
        ...
        for (let input of this._inputs) {
            ...
            const buildInput = {
                ...
                checked: (this._request._first && input._checked) || (!this._request._first && ((type == 'checkbox' && this._request._values[input._name] !== null) || (type != 'checkbox' && this._request._values[input._name] !== null))),
            ...
            if (!this._hasPages()) {
                ...
                if (page === undefined) {
                    ...
                    if (index == -1) {
                        ...
                        return this._makeUrl(this._driver.url(), this._request._token, page)
                    }
                }
            }
        }
