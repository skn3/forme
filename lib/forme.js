...
class Forme extends FormeContainer {
    ...
    _build(view, submit, values) {
        const hasPage = !!this._request._page;
        ...
        return this._buildSteps(view, submit, values, [
            ...
            //load
            this._buildLoadHandlers,
            hasPage?() => this._request._page._buildLoadHandlers():null,

            //build
            this._buildBuildHandlers,
            hasPage?() => this._request._page._build():null,

            //children
            this._buildChildren,
            hasPage?() => this._request._page._buildChildren():null,
