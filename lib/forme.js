                        ...
                        if (req.forme[that._name].errors.length > 0) {
                            ...
                            that.store(req, function (error) {
                                if (error) {
                                    ...
                                    if (callback != null) {
                                        ...
                                        errors.push(error);
                                        callback.call(that, req, that, false, that.values(req, false, true, false), errors);
                                    }
                                } else {
                                    //session saved
                                    if (callback != null) {
                                        callback.call(that, req, that, false, that.values(req, false, true, false), req.forme[that._name].errors);
                                    }
                                }
                            });
                        } else {
                            ...
                            async.eachSeries(that._inputs, function (input, nextInput) {
                                ...
                                async.eachSeries(that._submit, function (submitCallback, nextCallback) {
                                    ...
                                    if (callback != null) {
                                        callback.call(that, req, that, true, that.values(req, false, true, false), null);
                                    }
                                });
                            });
                        }
