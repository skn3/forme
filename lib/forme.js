...
class Forme extends FormeContainer {
    ...
    _buildRequest(external) {
        //override teh current page that was default set in request._load()
    ...
    _buildReadFinish(out, external) {
        //store these in teh request once the entire read operation has finished!
    ...
    _executeReadHandler(handler, value) {
        return Promise.resolve(handler.call(this, this.form, value));
    }
