...
class FormeResult {
    constructor(form) {
        ...
        this._template = this._form._request._view ? this._form._makeTemplate() : null;//only bother generating template when viewing
    };
    ...
    get destination() {
        let destination = this._destination === null?this._form._driver.url():this._destination;
        let addQuery = null;
        const removeQuery = [];
