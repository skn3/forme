...
class FormeBase {
    constructor(name) {
        ...
        this._overwrite = undefined;//overwrite value! Does not need to be used by input because value can always be set internally for an input!
    ...
    get _overwritten() {
        return this._overwrite !== undefined;
    }
    ...
    _processElementStateChanges(handler, oldState, newState, overwrite) {
