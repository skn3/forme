...
class FormeBase {
    ...
    _processGetters(value) {
        //pass the value through any getters this element may have
        if (this._getterHandlers.length > 0) {
    ...
    _setValue(value, merge, setters) {
        ...
        if (!this._setValueSetter(value, merge, setters)) {
