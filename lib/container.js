                ...
                .then(() => {
                    ...
                    if (inputs && inputs.length) {
                        ...
                        for (let input of inputs) {
                            ...
                            const newName = `__forme_component_input__${component._name}__${oldName}`;
                            input.name(newName);//set the name to our unique name
                            input.alias(oldName);//set the alias to the original name so that template/state work properly
