...
const {FormeConfigurableMethod, FormeConfigurableOverride, FormeConfigurableParam, FormeConfigurableString, FormeConfigurableObject, FormeConfigurableCallbacks, FormeConfigurableStrings} = require('./configurable');
...
class FormeContainer extends FormeBase {
    ...
    _add(details) {
        if (details && typeof details === 'object') {
            ...
            //add and configure
            return this._addInput(new this._form._driverClass.inputClass(this._form, details.name)).configure(details);
        } else {
            ...
            //add
            return this._addInput(new this._form._driverClass.inputClass(this._form, details));
        }
    }

    //public methods
    add(details) {
        if (this.callingConfigureMethod('store')) {
            //how many?
